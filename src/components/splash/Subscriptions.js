...
const Subscriptions = ({navigation, session}) => {
                ...
                Restore Purchase
                    ...
                    <View style={{paddingHorizontal: 15, marginVertical: 15}}>
                        <TouchableNativeFeedback
                            ...
                            background={TouchableNativeFeedback.Ripple(Colors.buttonColor)}
                        >
                            <LinearGradient
                                useAngle
                                angle={0}
...
export default WrappedComponent(Subscriptions);
